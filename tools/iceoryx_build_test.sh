...
while (( "$#" )); do
  case "$1" in
    ...
    "with-eth-gateway")
        ...
        ;;
    "with-ros-gateway")
        echo " [i] Including ros gateway in build"
        ROS_GATEWAY_FLAG="ON"
        shift 1
        ;;
    "build-test")
