...
#ifndef IOX_ros_ros_DATA_READER_HPP
#define IOX_ros_ros_DATA_READER_HPP
...
class DataReader
{
  public:
    ///
    /// @brief connect Connect the DataReader to the underlying ros network.
    ///
    ...
    ///
    /// @brief take Take the next available sample from the ros data space.
    ...
    ///
    /// @brief take Take up to a maximum number of samples from the ros data space.
...
#endif // IOX_ros_ros_DATA_READER_HPP
