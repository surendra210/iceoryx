...
class CycloneContext
{
  public:
    ///
    /// @brief getParticipant Get the ros Domain Participant for the current runtime.
    /// @return The ros Domain Participant.
    ///
    //static ::ros::domain::DomainParticipant& getParticipant() noexcept;
};
