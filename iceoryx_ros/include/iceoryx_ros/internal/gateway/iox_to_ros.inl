...
template <typename channel_t, typename gateway_t>
int Iceoryx2rosGateway<channel_t, gateway_t>::GetSocketChannelID(){
    return 0;
}
template <typename channel_t, typename gateway_t>
inline Iceoryx2rosGateway<channel_t, gateway_t>::~Iceoryx2rosGateway() noexcept
...
{
    iox::LogDebug() << "[Iceoryx2rosGateway] Configuring gateway...";
...
template <typename channel_t, typename gateway_t>
inline void Iceoryx2rosGateway<channel_t, gateway_t>::discover(const iox::capro::CaproMessage& msg) noexcept
{
    iox::LogDebug() << "[Iceoryx2rosGateway] <CaproMessage> "
...
template <typename channel_t, typename gateway_t>
inline void Iceoryx2rosGateway<channel_t, gateway_t>::forward(const channel_t& channel) noexcept
{
...
Iceoryx2rosGateway<channel_t, gateway_t>::setupChannel(const iox::capro::ServiceDescription& service) noexcept
{
